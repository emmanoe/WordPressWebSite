...
if ('/home/emmanoe/App/wordpress-5.6-0/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/emmanoe/App/wordpress-5.6-0/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {

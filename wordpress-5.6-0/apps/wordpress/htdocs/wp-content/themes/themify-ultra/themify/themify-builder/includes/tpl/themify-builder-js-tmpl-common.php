	...
	<ul class="tb_action_breadcrumb"></ul>
        <div class="tb_lightbox_top_bar clearfix">
            ...
            <div class="tb_lightbox_actions">
                <a class="builder_cancel_docked_mode"><?php echo themify_get_icon('new-window','ti')?></a>
...
<template id="tmpl-builder_row_action">
	...
	<li class="tb_row_settings" data-href="tb_row_options">
	    <?php echo themify_get_icon('settings','ti'); ?>
	    <div class="themify_tooltip"><?php _e('Options', 'themify') ?></div>
	</li>
	<li class="tb_styling">
	    <?php echo themify_get_icon('brush','ti'); ?>
	...
	<li class="tb_action_more">
		...
		<li class="tb_export"><?php echo themify_get_icon('export','ti'),__(' Export', 'themify') ?></li>
		<li class="tb_import"><?php echo themify_get_icon('import','ti'),__(' Import', 'themify') ?></li>
		<li class="tb_copy_component"><?php echo themify_get_icon('files','ti'),__(' Copy', 'themify') ?></li>
		<li class="tb_inner_action_more">
		    <?php echo themify_get_icon('clipboard','ti'),__(' Paste', 'themify') ?>
		    <ul>
		...
		<li class="tb_visibility_component">
		    <?php echo themify_get_icon('eye','ti'),__(' Visibility', 'themify') ?>
		</li>
	    </ul>
	</li>
    </ul> 
    <div id="tb_row_options" class="tb_toolbar_tabs">
	<a href="#" class="tb_row_hover_expand tb_edit"><?php echo themify_get_icon('new-window','ti')?></a>
...
<template id="tmpl-builder_column_action">
	...
	<li class="tb_import">
	    <?php echo themify_get_icon('import','ti'); ?>
	...
	<li class="tb_copy_component">
	    <?php echo themify_get_icon('files','ti'); ?>
	    <div class="themify_tooltip"><?php _e('Copy', 'themify') ?></div>
	</li>
	<li class="tb_inner_action_more">
	    <?php echo themify_get_icon('clipboard','ti'); ?>
...
<template id="tmpl-builder_subrow_action">
	...
	<li class="tb_action_more">
	    ...
	    <ul>
		<li class="tb_export">
		    <?php echo themify_get_icon('export','ti'), __('Export', 'themify'); ?>
		</li>
		<li class="tb_import">
		    <?php echo themify_get_icon('import','ti'), __('Import', 'themify'); ?>
		</li>
		<li class="tb_copy_component">
		    <?php echo themify_get_icon('files','ti'), __('Copy', 'themify'); ?>
		</li>
		<li class="tb_inner_action_more">
		    <?php echo themify_get_icon('clipboard','ti'), __('Paste', 'themify'); ?>
		    <ul>
...
<template id="tmpl-global_styles">
	...
	<div class="tb_gs_items_header">
		...
		<?php echo themify_get_icon('new-window','ti'),__('Manage Styles', 'themify') ?>
	    </a>
	</div>

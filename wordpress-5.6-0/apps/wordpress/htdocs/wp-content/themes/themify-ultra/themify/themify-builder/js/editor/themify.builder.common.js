...
(function ($, Themify, topWindow, document) {
    ...
    if (window.top !== window.self) {
        window.wp.shortcode = window.top.wp.shortcode;
        jQuery.ui = window.top.jQuery.ui;
        jQuery.fn.mouse = window.top.jQuery(window.top.document).mouse;
    ...
    ThemifyBuilderCommon = {
        ...
        Lightbox: {
            ...
            setup() {
                const Common = ThemifyBuilderCommon;
                ...
                Common.LiteLightbox.modal = new wp.media.view.Modal({
                    controller: {trigger() {
                        }}
                });
            ...
            resizable: {
                ...
                maxWidth: 880,
                minHeight: 320,
                maxHeight: topWindow.document.documentElement.clientHeight * .9, // 90vh
                update: true,
                init() {
                    const self = this,
                    ...
                    const items = this.$el[0].getElementsByClassName('tb_resizable');
                ...
                stop(e) {
                    const lightbox = ThemifyBuilderCommon.Lightbox,
                    ...
                    lightbox.fixContainment();
                    self.remember();
                    let $body = $('body', topWindow.document);
                    $body = $body.add('body');
                ...
                drag(e, ui) {
                    if (tb_app.mode === 'visual' && !this.get()) {
                        ...
                        if (!cl.contains('tb_standalone_lightbox')) {
                            const check = e.pageX + 20 >= topWindow.innerWidth,
                                    type = e.type;
                                ...
                                if (!tabsWidth) {
                                    ...
                                    if (ul !== undefined) {
                                        ...
                                        if(document.dir==='rtl'){
                                            ...
                                            tabsWidth = (window.innerWidth - (last.offset().left + lastw)) + lastw - (window.innerWidth - (tabs.offset().left + tabs.outerWidth()));
                                        }else{

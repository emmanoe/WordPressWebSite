        ...
        if(is_page() || themify_is_shop()) {
            ...
            if(is_singular('portfolio')) {
                ...
                if(is_singular('post')) {
                    ...
                    $this->media_position='auto_tiles'===$this->post_layout || in_array($this->post_layout_type,array('polaroid','flip'))?'above':themify_get($post_meta_key.'single_media_position', 'above', true);
                }
                $excluded_types=apply_filters('themify_exclude_CPT_for_sidebar', array('post', 'page', 'attachment', 'tbuilder_layout', 'tbuilder_layout_part', 'section'));
